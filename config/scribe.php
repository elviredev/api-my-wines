...
return [
    ...
    'title' => config('app.name').' API Le Verre & le Bouchon - Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => <<<'TEXT'
API REST développée avec Laravel 13 permettant la gestion d'une cave à vins personnelle.

Fonctionnalités :

- Authentification avec Laravel Sanctum
- Gestion du profil utilisateur
- CRUD complet des vins
...
TEXT,
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenez ce token via le endpoint <b>POST /api/login</b>.',
    ],
